    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl p-8 max-w-md shadow-soft">
          ...
          <h2 className="font-serif text-2xl text-brand-primary mb-2 text-center">Cannot Load Lesson</h2>
          <p className="text-gray-600 text-center mb-4">{error}</p>
          <button
            onClick={loadNode}
            className="w-full text-white px-6 py-3 rounded-xl transition-all mb-2" style={{ background: 'var(--gw-brand-primary, #5E1914)' }}
          >
            Retry
          </button>
          <button
          ...
          <div className="prose prose-lg max-w-none">
            <ReactMarkdown
              components={{
                ...
                h3: ({ children }) => <h3 className="font-serif text-2xl text-brand-secondary mb-2 mt-4">{children}</h3>,
                h4: ({ children }) => <h4 className="font-serif text-xl text-brand-secondary mb-2 mt-3">{children}</h4>,
