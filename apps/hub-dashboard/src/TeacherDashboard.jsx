                    ...
                    {assignmentForm.assignment_type === 'grammar-practice' && (
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <select
                            value={assignmentForm.level_range || '1'}
                          ...
                          >
                            ...
                            <option value="1-4">Levels 1–4 (All)</option>
                          </select>
                          <p className="text-xs text-slate-500 mt-1">Assignment completes when student passes all required levels.</p>
                        </div>
                      </div>
                    )}
